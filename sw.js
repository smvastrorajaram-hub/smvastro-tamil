const CACHE_NAME='smv-astro-en-20260911c';
const APP_SHELL=['./index.html','./legacy.css?v=20260911c','./interface.css?v=20260911c','./interface.js?v=20260911c','./app.mjs?v=20260911c','./public-content.mjs?v=20260911c','./admin-workflows.mjs?v=20260911c','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
